 ...
 * @author eyya
 */
public class StaffChangePwd extends javax.swing.JFrame {
    ...
    public StaffChangePwd(String user){
        user = username;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Edit Staff Profile");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 220, -1));
        ...
        jPanel1.add(jLabelBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, -1, -1));
        ...
        setSize(new java.awt.Dimension(790, 562));
    ...
    void ChangePassword(){
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                {
                    conn = MysqlConnect.ConnectDB();
                    String sql1= "update staff set Password= '" + Newpass + "' where Username= '" + uName + "' and Password = '" + OldPass + "'";
    ...
    private void jLabelBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBackMouseClicked
        // TODO add your handling code here:
        StaffHomepage s = new StaffHomepage(username);
        s.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffChangePwd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffChangePwd().setVisible(true);
            }
        });
    }
